...
function NavBar() {
  ...
  return (
    <nav className="p-3  bg-[#648908]  rounded border-gray-200 dark:bg-gray-800 dark:border-gray-700">
      <div className="container flex flex-wrap justify-between items-center mx-auto">
        <a href="#" className="flex items-center">
          <img
            className="self-center w-20 h-15 font-semibold whitespace-nowrap dark:text-white"
            src="https://www.pinclipart.com/picdir/big/19-194614_pizza-delivery-italian-cuisine-chef-cartoon-chef-pizza.png"
            alt=""
          />
        </a>
        <button
        ...
        <div className="hidden w-full md:block md:w-auto" id="navbar-solid-bg">
          <ul className="flex flex-col mt-4 bg-gray-50 rounded-lg md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-transparent dark:bg-gray-800 md:dark:bg-transparent dark:border-gray-700">
            <li>
              <Link
                to={"/"}
                className="block  py-2 pr-4 pl-3 text-white bg-white rounded md:bg-transparent "
                aria-current="page"
              >
                Home
              </Link>
